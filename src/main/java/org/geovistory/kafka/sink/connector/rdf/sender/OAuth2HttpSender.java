...
final class OAuth2HttpSender extends HttpSender {
    ...
    private final HttpRequestBuilder.OAuth2HttpRequestBuilder oauth2HttpRequestBuilder;

    OAuth2HttpSender(final HttpSinkConfig config, final HttpRequestBuilder.OAuth2HttpRequestBuilder accessTokenRequestBuilder) {
        super(config);
